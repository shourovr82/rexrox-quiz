...
const Blogs = () => {
  return (
    <div className=' pt-10'>
      <div className=' md:p-16 w-11/12  mx-auto grid gap-4'>


        <div className="text-start p-6 border-l-8 sm:py-8  shadow-lg rounded-lg border-emerald-600 bg-gray-900 text-gray-100">
        ...
        <div className="text-start shadow-lg rounded-lg p-6 border-l-8 sm:py-8 border-emerald-600 bg-gray-900 text-gray-100">
